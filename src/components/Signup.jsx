...
function Signup() {
  ...
  return (
    <>
  <div className='signupsection flex justify-center items-center'>
    <div class="bg-white px-10 py-8 rounded-xl w-screen shadow-lg max-w-sm ">
      <div class="space-y-4">
        <h1 class="text-center text-2xl font-semibold text-cyan-600">Sign Up</h1>
        <div>
      ...
      <button class="mt-4 w-full bg-gradient-to-tr from-cyan-600 to-cyan-700 text-indigo-100 py-2 rounded-md text-lg tracking-wide">Sign Up</button>
    </div>
  </div>
